  ...
  >
    ...
    >
      ...
      <template v-else-if="suffixIcon">
        <view
          v-bind:class="[
            isActive === true ? 'active-comment' : 'unactive-comment',
          ]"
          @click="pubComment"
        >
          <text>发布</text>
...
export default {
  ...
  data() {
    return {
      ...
      border: false,
      isActive: false,
      activeClass: "active-comment",
      unactiveClass: "unactive-comment",
      isFirstBorder: false,
      showClearIcon: false,
      showPassword: false,
    };
